...
############### Blackjack Project #####################
############### Michael's Blackjack House Rules #####################
...
#If you don't understand blackjack, go to this website and try out the Blackjack game:
...
def calculate_score(cards):
  ...
  if sum(cards) == 21 and len(cards) == 2:
    return 0
  #Inside calculate_score() check for an 11 (ace). If the score is already over 21, remove the 11 and replace it with a 1. Look up append() and remove().
